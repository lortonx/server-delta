...
declare module 'parse-server' {
    ...
    export namespace SchemaMigrations {
        ...
        function makeSchema<T extends JSONSchema>(className: ClassNameType, schema: T): T;
    }

    interface FieldTypeToType {
        String: string;
        Boolean: boolean;
        File: Parse.File;
        Number: number;
    ...
    export type RecordToType<T extends SchemaMigrations.FieldsInterface> = {
        [K in keyof T]?: FieldTypeToType[T[K]['type']];
    } & Parse.Attributes;
}
